...
\begin{tikzpicture}
  ...
  \umlclass[x=-2.1, y=-15,type=enum]{LotStatus}{Unsold \\ In auction \\ Sold \\ Sold pending payment}
  ...
  \umlclass[type = interface, x=25,y=-19]{AuctionHouse}{
  }
  {
    registerBuyer() \\
    registerSeller() \\
  ...
  \umlclass[type = interface, x=11,y=-5]{BankingService}{
  }
  {
    transfer()
  }
  
  \umlclass[x=11,y=-5]{CatalogueEntry}{
    lotNumber : int \\
    description : String \\
    status : LotSTatus 
  }
