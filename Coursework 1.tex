...
\begin{tikzpicture}
    ...
    \umlusecase[y=2]{Bid on lot}
    \umlusecase[x=4, y=2]{Close lot auction}
    \umlusecase[y=4]{Register buyer}
    \umlusecase[y=6]{Note interest in lot}
    \umlusecase[x=4]{Add lot listing}
    \umlusecase[y=0]{Browse}
    \umlusecase[x=4, y=4]{Start lot auction}
\end{umlsystem} 
 
    \umlactor[x=12, y=8]{Auction house}
    \umlactor[x=12, y=5]{Auctioneer}
    \umlactor[y=6]{Buyer}
    \umlactor[x=12, y=2]{Seller}
    \umlactor[x=3]{Member of the public}
    \umlactor[x=7]{Expert}
    \umlactor[x=10]{Lot display professional}
